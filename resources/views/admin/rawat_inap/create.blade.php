    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="/admin/rawat-inap" method="POST" onsubmit="return confirm('Apakah anda yakin akan menambah data ini? silahkan cek lagi karena data tidak akan dapat di ubah!')">
            @csrf
            <div class="form-body">
              <div class="row">
                <div class="col-md-12">
